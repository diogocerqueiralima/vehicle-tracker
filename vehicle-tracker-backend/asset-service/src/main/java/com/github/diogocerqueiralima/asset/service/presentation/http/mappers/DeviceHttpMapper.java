...
public final class DeviceHttpMapper {
    ...
    /**
     *
     * Builds a create-or-update command from an HTTP path identifier and a request payload.
     *
     ...
     */
    public static CreateOrUpdateDeviceCommand toCommand(UUID id, CreateOrUpdateDeviceRequestDTO request) {
        return new CreateOrUpdateDeviceCommand(
                id,
