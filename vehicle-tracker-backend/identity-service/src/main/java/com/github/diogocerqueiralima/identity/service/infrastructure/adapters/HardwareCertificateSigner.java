...
public class HardwareCertificateSigner implements CertificateSigner {
    ...
    public byte[] sign(
        ...
        try {
            ...
            throw new OperationFailedException("Could not sign the certificate.");
        }
    ...
    private byte[] convertToPem(X509CertificateHolder holder) {
        ...
        try {
            ...
            throw new OperationFailedException("It was not possible to convert the certificate to PEM format.");
        }
