package com.github.diogocerqueiralima.domain.model.certificate.options;

/**
 * Represents options for revoking a certificate.
 * This class is immutable and provides a method to validate the options.
 */
public class RevokeCertificateOptions implements com.github.diogocerqueiralima.domain.model.certificate.options.CertificateOptions {
