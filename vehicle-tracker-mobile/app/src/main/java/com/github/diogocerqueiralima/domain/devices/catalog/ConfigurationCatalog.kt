...
enum class CharacteristicFormat {
    ...
    /**
     * A value acted on (downloaded/uploaded) rather than displayed: never decoded to or encoded
     * from a string. Always carried by the chunked `[total_len][offset]` transfer protocol (see
     * vehicle-tracker-embedded's gatt_common_file_access_cb / gatt_common_file_read_chunk).
     */
    FILE
}
...
object Catalog {
    ...
    private val connectionServiceId = Uuid.parse("1304eaaa-c937-511a-6605-c9858c877865")
    private val gpsServiceId = Uuid.parse("6ed54c3d-ca79-1398-7148-34a9bf29d12d")
    private val authenticationServiceId = Uuid.parse("347df573-cf50-f1b5-e749-1efe2d71272e")
        ...
        ServiceSpec(
            ...
            characteristics = listOf(
                CharacteristicSpec(
                    ...
                    characteristicId = Uuid.parse("755e0efa-870c-6f29-f505-577140f42a00"),
                ...
                CharacteristicSpec(
                    name = "keep_alive",
                    serviceId = connectionServiceId,
                    characteristicId = Uuid.parse("8f97f131-bce8-6f20-d10b-363ff3db3b19"),
                ...
                CharacteristicSpec(
                    name = "qos",
                    serviceId = connectionServiceId,
                    characteristicId = Uuid.parse("8611d086-a805-7f20-840d-5202ba787349"),
                ...
                CharacteristicSpec(
                    name = "recon_interval",
                    serviceId = connectionServiceId,
                    characteristicId = Uuid.parse("7caaecb0-677f-9131-4b0c-0ba295f27214"),
        ...
        ServiceSpec(
            ...
            characteristics = listOf(
                CharacteristicSpec(
                    ...
                    characteristicId = Uuid.parse("a7586118-a223-8f13-930b-215917f29126"),
                    format = CharacteristicFormat.UINT32,
                    readable = true,
                    writable = true,
                ...
                CharacteristicSpec(
                    name = "gps_timeout",
                    serviceId = gpsServiceId,
                    characteristicId = Uuid.parse("ca561647-1ef5-4213-190f-daf6f42c83d1"),
                    format = CharacteristicFormat.UINT32,
                    readable = true,
                    writable = true,
                ...
                CharacteristicSpec(
                    name = "gps_mode",
                    serviceId = gpsServiceId,
                    characteristicId = Uuid.parse("d67ed5fc-a8db-c68c-2544-e5ed59f356c6"),
                    format = CharacteristicFormat.STRING,
                    readable = true,
                    writable = true,
        ...
        ServiceSpec(
            ...
            characteristics = listOf(
                CharacteristicSpec(
                    ...
                    characteristicId = Uuid.parse("90785634-12ef-cd2b-9008-f6e5d4c3b2a1"),
                    format = CharacteristicFormat.FILE,
                    readable = true,
                    writable = false,
                ...
                CharacteristicSpec(
                    name = "certificate",
                    serviceId = authenticationServiceId,
                    characteristicId = Uuid.parse("df5c268d-107b-d836-e808-a442ac515561"),
                    format = CharacteristicFormat.FILE,
                    readable = true,
                    writable = true,
                ...
                CharacteristicSpec(
                    name = "ca",
                    serviceId = authenticationServiceId,
                    characteristicId = Uuid.parse("39897685-53c9-7092-d542-7dbfc95f7dce"),
                    format = CharacteristicFormat.FILE,
                    readable = true,
                    writable = true,
                ...
                CharacteristicSpec(
                    name = "revoke",
                    serviceId = authenticationServiceId,
                    characteristicId = Uuid.parse("6e5b0cbc-87f6-9c9a-4d43-e29bb72441aa"),
                ...
                CharacteristicSpec(
                    name = "expiration",
                    serviceId = authenticationServiceId,
                    characteristicId = Uuid.parse("7c85ca03-73b1-d990-6d4f-8267197e2e0e"),
                    format = CharacteristicFormat.STRING,
                    readable = true,
                    writable = true,
                ...
                CharacteristicSpec(
                    name = "status",
                    serviceId = authenticationServiceId,
                    characteristicId = Uuid.parse("aeb2f94c-b465-568d-264f-8a4ca22abc62"),
                    format = CharacteristicFormat.STRING,
                    readable = true,
                    writable = false,
