...
|---|---|---|---|---|---|
| gps_update | a7586118-a223-8f13-930b-215917f29126 | integer | read, write | The frequency in seconds at which the device updates its GPS location, from 1s to 255s. Updates only if the device is moving. | 60s |
